  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] selection:bg-black selection:text-white font-inter">
      ...
      <section className="section-padding pt-32 pb-20 md:pt-48 md:pb-32 bg-white border-b border-gray-100 relative overflow-hidden">
        <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-purple-50/40 blur-[150px] rounded-full -z-10" />
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          <div className="lg:w-1/2 space-y-8 reveal active">
            <div className="inline-flex items-center space-x-3 px-4 py-2 bg-purple-50 text-purple-600 rounded-2xl border border-purple-100/50">
              <Shield size={16} />
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] text-gray-900 italic">
              Advanced <br /><span className="text-purple-600 not-italic">Fraud Protection.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 pt-4">
              <Link
                to="/buy-plan"
                className="w-full sm:w-auto px-10 py-5 bg-black text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-xl hover:bg-purple-600 transition-all duration-500 hover:scale-105 active:scale-95 flex items-center justify-center space-x-3"
              >
               ...
               <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-5 bg-gray-50/50 rounded-2xl border border-gray-50 transition-colors hover:bg-white hover:shadow-lg">
                       <div className="flex items-center gap-4">
                          <scan.icon size={18} className="text-purple-600" />
                          <div>
                       ...
                       <span className="px-3 py-1 bg-purple-50 text-purple-600 text-[8px] font-black uppercase tracking-widest rounded-full">{scan.status}</span>
                    </div>
                  ))}
               </div>
               
               <div className="mt-10 pt-10 border-t border-gray-50 flex items-center justify-center">
                  <div className="inline-flex items-center gap-3 px-6 py-3 bg-emerald-50 text-emerald-600 rounded-full">
                     <ShieldCheck size={16} />
      ...
      <section className="section-padding py-24 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24 space-y-4">
              <h2 className="text-3xl md:text-6xl font-black tracking-tighter uppercase italic">Security <span className="text-purple-600 not-italic">Infrastructure.</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "AI claim validation", desc: "Proprietary models cross-calculate telemetry data with disruption reports to validate legality.", icon: Cpu, color: "bg-purple-50 text-purple-600" },
              ...
              { title: "Fraud detection models", desc: "Advanced behavioral analysis identifies anomalous claiming patterns before they escalate.", icon: ShieldCheck, color: "bg-emerald-50 text-emerald-600" },
              { title: "Secure payout processing", desc: "Dual-layer encryption for all wallet transfers ensures funds reach the right partner every time.", icon: Lock, color: "bg-orange-50 text-orange-600" }
            ].map((f, i) => (
              <div key={i} className="bg-white p-12 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 group text-center flex flex-col items-center">
                <div className={cn("inline-flex p-6 rounded-[2rem] mb-8 group-hover:scale-110 transition-transform", f.color)}>
                  <f.icon size={32} />
                </div>
                <h3 className="text-xl font-black tracking-tight mb-4 uppercase italic leading-none">{f.title}</h3>
      ...
      <section className="section-padding py-32 bg-white relative overflow-hidden group">
         <div className="absolute inset-0 bg-purple-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 -z-10" />
         <div className="max-w-3xl mx-auto text-center space-y-12">
            <h2 className="text-4xl md:text-7xl font-black tracking-tighter italic uppercase leading-none">Military-Grade <br /><span className="text-purple-600 not-italic">Assurance.</span></h2>
            ...
            <div className="flex items-center justify-center gap-6">
               <Link 
                 to="/buy-plan"
                 className="px-10 py-6 bg-black text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-purple-600 transition-all duration-500 hover:scale-[1.05] shadow-2xl"
               >
                 Start Protection
               </Link>
               <Link 
