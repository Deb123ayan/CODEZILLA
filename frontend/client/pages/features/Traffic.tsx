  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] selection:bg-black selection:text-white font-inter">
      ...
      <section className="section-padding pt-32 pb-20 md:pt-48 md:pb-32 bg-white border-b border-gray-100 overflow-hidden relative">
        {/* Glow behind content */}
        <div className="absolute top-1/2 left-0 w-full h-full -z-10 bg-blue-50/20 blur-[150px] rounded-full" />

        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
          <div className="lg:w-1/2 space-y-8 reveal active">
            <div className="inline-flex items-center space-x-3 px-4 py-2 bg-blue-50 text-blue-600 rounded-2xl border border-blue-100/30">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-tight text-gray-900">
              Traffic Disruption <br /><span className="text-blue-600">Protection.</span>
            </h1>
            <p className="text-lg md:text-xl font-bold text-gray-400 leading-relaxed max-w-lg">
              Get compensated when traffic delays affect delivery performance. Zafby analyzes traffic congestion and road disruptions to trigger compensation automatically.
            </p>
          ...
          <div className="lg:w-1/2 relative">
            <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] relative z-10">
              <div className="flex items-center justify-between mb-10">
                ...
                <span className="px-3 py-1 bg-blue-600 text-white text-[8px] font-black uppercase tracking-[0.2em] rounded">Alert</span>
              </div>
                ...
                <div className="p-6 bg-blue-50/50 rounded-2xl border border-blue-100 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h5 className="text-xl font-black text-blue-900">+18 Mins</h5>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Estimated Payout</p>
                    <h5 className="text-xl font-black text-blue-600">₹85.00</h5>
                  </div>
                </div>
      ...
      <section className="section-padding py-24 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter italic">Traffic Compensation <span className="text-blue-600 not-italic">Flow.</span></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:bg-black transition-all duration-500 group">
                <div className="w-20 h-20 bg-blue-50 text-blue-600 rounded-[1.5rem] flex items-center justify-center mb-10 group-hover:scale-110 transition-transform">
                  <s.icon size={36} />
                </div>
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4 italic group-hover:text-gray-300">Step {s.step}</p>
                <h3 className="text-2xl font-black tracking-tighter mb-4 uppercase group-hover:text-white">{s.title}</h3>
      ...
      <section className="section-padding py-24 bg-white border-t border-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter leading-none mb-8 italic">Protect your <br /><span className="text-blue-600 not-italic">Time & Money.</span></h2>
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-center space-x-6 group">
                    <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center group-hover:bg-blue-600 transition-all">
            ...
            <div className="bg-black rounded-[3rem] p-12 text-white shadow-2xl space-y-8 relative overflow-hidden group">
              ...
              <Link
                to="/buy-plan"
                className="w-full h-16 bg-white text-black rounded-2xl flex items-center justify-center font-black text-[10px] uppercase tracking-[0.2em] hover:bg-blue-600 hover:text-white transition-all duration-300"
              >
                Start Protection
              </Link>
            </div>
