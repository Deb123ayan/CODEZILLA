        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          <div className="lg:w-1/2 space-y-8 reveal active">
            ...
            <p className="text-lg md:text-xl font-bold text-gray-400 leading-relaxed max-w-lg italic">
              "No forms. No paperwork. Claims are triggered automatically." Zafby automatically detects eligible disruptions and triggers payouts without manual claim submission.
            </p>
