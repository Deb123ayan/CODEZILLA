  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] selection:bg-black selection:text-white font-inter">
      ...
      <section className="section-padding pt-32 pb-20 md:pt-48 md:pb-32 bg-white border-b border-gray-100 relative overflow-hidden">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-emerald-50/50 blur-[120px] rounded-full -z-10" />
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          <div className="lg:w-1/2 space-y-8 reveal active">
            <div className="inline-flex items-center space-x-3 px-4 py-2 bg-emerald-50 text-emerald-600 rounded-2xl border border-emerald-100/50">
              <Wallet size={16} />
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] text-gray-900 italic">
              Zero-Click <br /><span className="text-emerald-500 not-italic">Claims System.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 pt-4">
              <Link
                to="/buy-plan"
                className="w-full sm:w-auto px-10 py-5 bg-black text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-xl hover:bg-emerald-600 transition-all duration-500 hover:scale-105 active:scale-95 flex items-center justify-center space-x-3"
              >
          ...
          <div className="lg:w-1/2 relative group">
            <div className="bg-white rounded-[3rem] border border-gray-100 p-10 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] space-y-8 relative overflow-hidden transition-all duration-700 hover:shadow-emerald-500/10 hover:border-emerald-500/20">
               <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="text-right">
                     <p className="text-[10px] font-black uppercase tracking-widest text-emerald-600 leading-none mb-1">Status</p>
               ...
               <div className="space-y-6">
                  <div className="flex items-center group/item hover:translate-x-1 transition-transform cursor-default">
                     <div className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center mr-4 group-hover/item:bg-emerald-600 transition-colors">
                        <CheckCircle2 size={18} className="text-emerald-500 group-hover/item:text-white" />
                     </div>
               ...
               <div className="mt-10 p-6 bg-emerald-600 rounded-[2rem] text-white flex items-center justify-between group-hover:scale-[1.02] transition-transform duration-500 shadow-xl">
                  <div className="flex items-center gap-4">
      ...
      <section className="section-padding py-24 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic">Zero Paperwork <span className="text-emerald-500 not-italic">Reality.</span></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-12 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 group">
                <div className="w-20 h-20 bg-emerald-50 text-emerald-600 rounded-[2rem] flex items-center justify-center mb-10 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-500">
                  <s.icon size={36} />
                </div>
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4 tracking-[0.3em]">Phase {s.step}</p>
                <h3 className="text-2xl font-black tracking-tighter mb-4 uppercase italic leading-none">{s.title}</h3>
      ...
      <section className="section-padding py-24 bg-white border-t border-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="bg-black rounded-[4rem] p-12 md:p-24 text-white relative overflow-hidden group shadow-2xl">
             <div className="absolute top-0 left-0 w-full h-full bg-emerald-500/5 blur-[120px] pointer-events-none group-hover:bg-emerald-500/10 transition-colors" />
             <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
                <div className="space-y-10">
                   <h2 className="text-4xl md:text-7xl font-black tracking-tighter leading-none italic uppercase">Seamless <br /><span className="text-emerald-500 not-italic">Benefits.</span></h2>
                ...
                <div className="space-y-8 flex flex-col items-center lg:items-end text-center lg:text-right">
                   ...
                   <Link 
                     to="/buy-plan"
                     className="px-14 py-7 bg-white text-black rounded-3xl font-black text-[12px] uppercase tracking-[0.3em] hover:bg-emerald-500 hover:text-white transition-all duration-500 hover:scale-[1.1] active:scale-95 shadow-2xl"
                   >
                     Protect My Income
                   </Link>
                </div>
